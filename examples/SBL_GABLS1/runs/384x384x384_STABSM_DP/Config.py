...
# SGS model: 0 = Static SM, 1 = LASDD-SM, 2 = LASDD-WL,
#            3 = LAD-SM,    4 = LAD-WL,   5 = STAB-SM
optSgs = 5

# Dynamic SGS update frequency (not used for STAB-SM)
